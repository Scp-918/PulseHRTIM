...
void MX_HRTIM1_Init(void)
{
  ...
  pTimeBaseCfg.RepetitionCounter = 0x4;//1ms周期
  ...
  pCompareCfg.CompareValue = comp1_start_num+36;
  ...
  pCompareCfg.CompareValue = comp2_start_num+36;
